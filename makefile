...
INCLIB = -I$(INCDIR) -I$(SDLINCLUDE) -L$(SDLLIB) -I$(SDLIMAGEINCLUDE) -L$(SDLIMAGELIB) -I$(SDLMIXERINCLUDE) -L$(SDLMIXERLIB)
LDFLAGS = -lmingw32 -l$(LIBRARYSDLMAIN) -l$(LIBRARYSDL) -l$(LIBRARYSDLIMAGE) -l$(LIBRARYSDLMIXER) -mwindows -lwinmm
